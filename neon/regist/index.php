...
<?}elseif($action==2){?>
	...
	<section class="section_www_regist">
		<div class="section_www_regist_inner comp_">

		<img src="/neon/img/common/welcom_white_01.png" alt="" />
		<p class="contact_BOX_welcome">ようこそ、NEONへ！</p>
		<p class="contact_BOX_p">無料会員登録が完了しました。<br><br>ログインに必要なパスワードがメールアドレスへ<br>自動送信されましたのでご確認ください。</p>
		<p class="contact_BOX_p_sub">メールが届かない場合は、お問い合わせまたは、<br />異なるメールアドレスにてお手続きください。</p>

		<a href="/neon/login/index.php" class="button_">ログインへ進む</a>
		</div>
	</section>
