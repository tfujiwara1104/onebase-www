...
<?include_once("{$_SERVER['DOCUMENT_ROOT']}/neon/inc/smp_select/paid_.inc")?>
<style type="text/css">.display_menu {display: none!important;}.display_rule {display: block!important;}#paid__ {background-color: #dfdfdf!important;}
@media (max-width:768px) {.display_rule {display: none!important;}}</style>
<section class="section_www_rule">
	<h1>NEON 有料利用規約</h1>

	<?include_once("{$_SERVER['DOCUMENT_ROOT']}/neon/inc/rule_paid.inc")?>

	<h4>マーケット利用規約</h4>
	<p>マーケットプレイス「夢を叶える百貨店」のご利用は、企画・運営元のONE COLLEGE合同会社が提示する利用規約に準ずるものとする。</p>
