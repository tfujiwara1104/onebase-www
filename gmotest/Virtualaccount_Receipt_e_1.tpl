...
<div class="header">
	...
	<div class="main">
		...
		<form action="{$RetURL|htmlspecialchars}" method="post" onsubmit="return blockForm()">
			...
			<p class="txt_virtual">銀行振込は決済代行会社指定のバーチャル口座へご入金いただくことで決済が完了します。</p>
			<p class="txt_virtual">振込期限に限らず、すみやかに振込みを行ってください。</p>
			<p class="txt_virtual">振込みの際は、<span class="txt_span">振込依頼人欄に「 振込コード ＋ お客様の氏名 」を入力</span>してください。</p>
			...
			<div class="block">
				...
				<div class="bl_body">
					<div>
						...
						<p class="txt_virtual02">お振込みの際は、振込依頼人欄に「 振込コード ＋ お客様の氏名 」を入力してください。</p>
